  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-green-800 via-green-900 to-green-950 py-12 sm:py-16 md:py-24">
          ...
          <div className="absolute -bottom-10 -left-10 h-32 w-32 sm:h-64 sm:w-64 rounded-full bg-amber-500/10 blur-3xl"></div>
          <div className="absolute -top-10 -right-10 h-32 w-32 sm:h-64 sm:w-64 rounded-full bg-amber-500/10 blur-3xl"></div>
          ...
          <div className="container relative px-4 sm:px-6">
            ...
            <div className="grid gap-8 sm:gap-12 md:grid-cols-2 items-center">
              ...
              <div className="relative mx-auto w-full max-w-xs sm:max-w-md">
                <div className="absolute -top-4 -left-4 sm:-top-6 sm:-left-6 h-16 w-16 sm:h-24 sm:w-24 rounded-full bg-amber-500/30 blur-xl"></div>
                <div className="absolute -bottom-6 -right-6 sm:-bottom-8 sm:-right-8 h-20 w-20 sm:h-32 sm:w-32 rounded-full bg-amber-500/30 blur-xl"></div>
                <div className="relative aspect-square overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-green-700 to-green-900 p-1 shadow-xl">
                ...
                <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 h-16 w-16 sm:h-24 sm:w-24 rounded-full bg-amber-500 shadow-lg flex items-center justify-center">
                  <Beer className="h-6 w-6 sm:h-10 sm:w-10 text-green-900" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 sm:px-6">
            <div className="grid gap-8 sm:gap-12 md:grid-cols-2 items-center">
              <div className="order-2 md:order-1">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm sm:text-base">Materiais para o Estabelecimento</p>
                      <p className="text-muted-foreground text-xs sm:text-sm">
              ...
              <div className="order-1 md:order-2">
                <div className="relative mx-auto w-full max-w-xs sm:max-w-md">
                  <div className="absolute -top-4 -left-4 sm:-top-6 sm:-left-6 h-16 w-16 sm:h-24 sm:w-24 rounded-full bg-amber-100 blur-xl"></div>
                  <div className="absolute -bottom-6 -right-6 sm:-bottom-8 sm:-right-8 h-20 w-20 sm:h-32 sm:w-32 rounded-full bg-green-100 blur-xl"></div>
                  <div className="relative aspect-square overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-green-700 to-green-800 p-1 shadow-xl">
                    <div className="h-full w-full overflow-hidden rounded-[calc(1rem-4px)] sm:rounded-[calc(1.5rem-4px)] bg-white">
                      <Image
                  ...
                  <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 h-16 w-16 sm:h-24 sm:w-24 rounded-full bg-amber-500 shadow-lg flex items-center justify-center">
                    <Utensils className="h-6 w-6 sm:h-10 sm:w-10 text-white" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
          <div className="container px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16 max-w-3xl mx-auto">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tighter">Paleta de Cores</h2>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold mb-2">Cores Principais</h3>
              ...
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm sm:text-base">Legibilidade e Personalidade</p>
                      <p className="text-muted-foreground text-xs sm:text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm sm:text-base">Elementos Decorativos</p>
                      <p className="text-muted-foreground text-xs sm:text-sm">
            ...
            <div className="mt-16 sm:mt-20">
              ...
              <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-2">
                <div className="bg-white rounded-xl overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold mb-2">Versão Verde</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                ...
                <div className="bg-white rounded-xl overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold mb-2">Versão Âmbar</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
          ...
          <div className="container px-4 sm:px-6">
            ...
            <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-2">
              <div className="bg-white rounded-xl overflow-hidden shadow-lg">
                ...
                />
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-bold mb-2">Canecas e Copos</h3>
                  <p className="text-muted-foreground text-sm sm:text-base">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-lg">
                ...
                />
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-bold mb-2">Placa Externa</h3>
                  <p className="text-muted-foreground text-sm sm:text-base">
          ...
          <div className="container px-4 sm:px-6">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-white rounded-xl p-6 sm:p-8 shadow-md border border-gray-100 hover:border-[#7c4dff]/30 hover:shadow-lg transition-all hover:-translate-y-2">
                <div className="mb-4 sm:mb-6 flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-green-100 text-green-800">
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 shadow-md border border-gray-100 hover:border-[#7c4dff]/30 hover:shadow-lg transition-all hover:-translate-y-2 sm:col-span-2 lg:col-span-1">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2">Experiência</h3>
                <p className="text-muted-foreground text-sm sm:text-base">
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-[#7c4dff] to-[#6a3afc] relative overflow-hidden">
          ...
          <div className="absolute -top-16 -left-16 sm:-top-24 sm:-left-24 h-32 w-32 sm:h-48 sm:w-48 rounded-full bg-amber-500/30 blur-3xl"></div>
          <div className="absolute -bottom-16 -right-16 sm:-bottom-24 sm:-right-24 h-32 w-32 sm:h-48 sm:w-48 rounded-full bg-amber-500/30 blur-3xl"></div>
          ...
          <div className="container relative px-4 sm:px-6">
            <div className="grid gap-6 sm:gap-8 md:grid-cols-2 items-center">
              ...
              <div className="relative mx-auto w-full max-w-sm">
                ...
                <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 h-16 w-16 sm:h-24 sm:w-24 rounded-full bg-amber-500 shadow-lg flex items-center justify-center">
                  <Sparkles className="h-6 w-6 sm:h-10 sm:w-10 text-green-900" />
                </div>
              </div>
            </div>
          </div>
